...
import com.autoever.carstore.car.service.implement.CarServiceImplement;
...
public class FCMController {
    ...
    private final CarServiceImplement carServiceImplement;
    ...
    @PutMapping("/discount")
    public ResponseEntity<?> discount() throws Exception {

        carServiceImplement.updateDiscountPrice();
